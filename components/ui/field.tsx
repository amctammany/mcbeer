...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-0 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-1",
        className,
      )}
      {...props}
    />
...
const fieldVariants = cva(
  "group/field flex w-full gap-0 p-1 data-[invalid=true]:text-destructive",
  {
    variants: {
      orientation: {
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:bg-primary/5 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border *:data-[slot=field]:p-1 dark:has-data-checked:bg-primary/10",
